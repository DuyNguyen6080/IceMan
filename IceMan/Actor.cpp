...
Boulder::Boulder(int X, int Y, StudentWorld* p) : ActivatingObject(IID_BOULDER, X, Y, down, 1, 1, p) {}

Oil::Oil(int X, int Y, StudentWorld* p) : ActivatingObject(IID_BARREL, X, Y, right, 1, 2, p) {
	this->setVisible(false); //fix this
}

Gold::Gold(int X, int Y, StudentWorld* p) : ActivatingObject(IID_GOLD, X, Y, right, 1, 2,p) {
...
Water::Water(int X, int Y, StudentWorld* p) : ActivatingObject(IID_WATER_POOL, X, Y, right, 1, 2, p) {
